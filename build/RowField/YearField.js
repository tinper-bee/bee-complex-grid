...
var YearField = function (_Component) {
    _inherits(YearField, _Component);
    ...
    YearField.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
        //当校验外部发生变化，主动校验函数
    ...
    YearField.prototype.render = function render() {
